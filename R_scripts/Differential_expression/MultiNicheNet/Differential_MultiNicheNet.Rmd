...
contrasts_oi = c("'no-yes','yes-no'")
contrast_tbl = tibble(contrast = c("no-yes", "yes-no"), group = c("no", "yes"))
...
```{r}
# === Filter out cells with missing sample_id, group_id, or celltype_id
SAB.sce <- SAB.sce[
...
# Output directory
out_dir <- "C:/Users/Robbe Fonteyn/OneDrive - UGent/AJ 2024-2025/Master's_Dissertation/Results/DE_yes vs_no_nichenet_Azimuth_cluster_majority_celltype_l2_harmony"
...
setwd("C:/Users/Robbe Fonteyn/OneDrive - UGent/AJ 2024-2025/Master's_Dissertation/Results/DE_yes vs_no_nichenet_Azimuth_cluster_majority_celltype_l2_harmony")
